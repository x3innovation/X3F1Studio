...
rtpg.ui.resizeElements = function() {
  $('#rightContainer2').width($(document).width() -
      $('#leftContainer2').width());
  if ($(window).scrollTop() >=
      ($('#rp-googlebar').outerHeight() + $('#logTitle').outerHeight() - 30)) {
    $('#logContainer').height($('body').height() -
        $('.rp-appbar').outerHeight() + 22);
    $('#rightContainer2').css('position','fixed');
    $('#rightContainer2').css('top','67px');
    $('#rightContainer2').css('right','0');
    ...
    $('#logContainer').height($('body').height() -
        ...
        16 +
        $(window).scrollTop());
    $('#rightContainer2').css('position','relative');
    $('#rightContainer2').css('top','');
    $('#rightContainer2').css('right','0');
  }
};
